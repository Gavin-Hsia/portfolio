...
Add the deeper notes — the buffer/coefficient design, how you validated against MATLAB-designed
filters, measured throughput on the M4, and a frequency-response plot. Link the repo if it’s
public.
